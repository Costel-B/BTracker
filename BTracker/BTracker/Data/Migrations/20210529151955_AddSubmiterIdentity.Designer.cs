...
namespace BTracker.Migrations
{
    ...
    [Migration("20210529151955_AddSubmiterIdentity")]
    partial class AddSubmiterIdentity
    {
            ...
            modelBuilder.Entity("BTracker.Models.Ticket", b =>
                {
                    ...
                    b.Property<string>("UserSubmiterId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("BTracker.Models.Ticket", b =>
                {
                    ...
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", "UserSubmiter")
                        .WithMany()
                        .HasForeignKey("UserSubmiterId");
